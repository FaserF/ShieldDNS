...
var DefaultPresets = []List{
	// --- Official ---
	{Name: "ShieldDNS Official Blocklist", URL: "https://raw.githubusercontent.com/FaserF/ShieldDNS/main/official/blocklists/default.txt", Enabled: true, Category: "Official"},
	...
	{Name: "AdGuard DNS filter (Main)", URL: "https://adguardteam.github.io/AdGuardSDNSFilter/Filters/filter.txt", Enabled: false, Category: "General Blocking"},
	...
	{Name: "AdGuard Annoyances Filter", URL: "https://adguardteam.github.io/HostlistsRegistry/assets/filter_48.txt", Enabled: false, Category: "Privacy & Tracking"},
	...
	// --- Security & Malware ---
	{Name: "HaGeZi TIF (Threat Intelligence)", URL: "https://raw.githubusercontent.com/hagezi/dns-blocklists/main/hosts/tif.txt", Enabled: false, Category: "Security & Malware"},
	{Name: "HaGeZi Fake (Fake Stores/Malware)", URL: "https://raw.githubusercontent.com/hagezi/dns-blocklists/main/adblock/fake.txt", Enabled: false, Category: "Security & Malware"},
	{Name: "Phishing.Database (Phishing Domains)", URL: "https://raw.githubusercontent.com/Phishing-Database/Phishing.Database/master/phishing-domains-ACTIVE.txt", Enabled: false, Category: "Security & Malware"},
	...
	{Name: "URLHaus Filter (Curben)", URL: "https://gitlab.com/curben/urlhaus-filter/raw/master/urlhaus-filter-hosts.txt", Enabled: false, Category: "Security & Malware"},
	...
	{Name: "AdGuard German Blocklist Optimized", URL: "https://filters.adtidy.org/extension/ublock/filters/6_optimized.txt", Enabled: false, Category: "Regional & Languages"},
	...
	{Name: "iOS Ads", URL: "https://raw.githubusercontent.com/BlackJack8/iOSAdblockList/master/Hosts.txt", Enabled: false, Category: "Misc & Extra"},
}

var DefaultAllowlists = []List{
	{Name: "ShieldDNS Official Allowlist", URL: "https://raw.githubusercontent.com/FaserF/ShieldDNS/main/official/allowlists/default.txt", Enabled: true, Category: "Official"},
	{Name: "FaserF Whitelist", URL: "https://raw.githubusercontent.com/FaserF/adguardhome_lists/master/whitelist", Enabled: true, Category: "Official"},
	...
	{Name: "AnudeepND", URL: "https://raw.githubusercontent.com/anudeepND/whitelist/master/domains/whitelist.txt", Enabled: false, Category: "General Blocking"},
	...
	{Name: "Referral", URL: "https://raw.githubusercontent.com/anudeepND/whitelist/master/domains/referral-sites.txt", Enabled: false, Category: "General Blocking"},
